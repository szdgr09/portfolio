...
var Particles = class extends import_react.Component {
  ...
  async loadParticles() {
    ...
    const id = this.props.id ?? Particles.defaultProps.id ?? defaultId, container = this.props.url ? await tsParticles.loadJSON(id, this.props.url) : await tsParticles.load(id, this.props.params ?? this.props.options);
    await cb(container);
  }
};
